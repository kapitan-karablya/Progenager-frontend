        ...
        tasks: [
            {
                ...
                name: 'Придумать название приложения',
                assigneesId: null,
                startTime: null,
                endTime: '5 мая',
                description: null,
        ...
        tasks: [
            {
                ...
                name: 'Расписать требования к клиентской части приложенияв текстовой части диплома',
                assigneesId: null,
                startTime: null,
                endTime: '1 мая',
                description: null,
            ...
            },
            {
                ...
                name: 'Предварительные выводы неутешительны: экономическая повестка сегодняшнего дня не даёт нам иного выбора, кроме определения соответствующих условий активизации.',
                assigneesId: null,
                startTime: null,
                endTime: '15 апреля',
                description: null,
        ...
        tasks: [
            {
                ...
                name: 'Есть над чем задуматься: диаграммы связей неоднозначны и будут ограничены исключительно образом мышления. А также многие известные личности представляют собой не что иное, как квинтэссенцию победы ',
                assigneesId: null,
                startTime: null,
                endTime: '30 февраля',
                description: null,
